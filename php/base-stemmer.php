...
abstract class SnowballStemmer {
    ...
    protected function setCurrent( string $value ) {
        $this->current = $value;
        $this->cursor = 0;
    ...
    protected function copy_from( self $other) {
    ...
    // -- Getters named similarly to JavaScipt method. e.g. this.current.length => $this->currentLength()
